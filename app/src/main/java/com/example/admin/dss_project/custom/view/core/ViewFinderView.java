package com.example.admin.dss_project.custom.view.core;
...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultBorderStrokeWidth = (int) getContext().getResources().getDimension(R.dimen.margin_padding_5);
    private final int mDefaultBorderLineLength = (int) getContext().getResources().getDimension(R.dimen.margin_padding_60);
