...
import com.example.admin.dss_project.activity.WinFailActivity;
import com.example.admin.dss_project.activity.WinSuccessActivity;
            ...
            public void onResponse(Call<CheckInQRcode> call, Response<CheckInQRcode> response) {
                if (response != null) {
                    ...
                    if(response.body().getStatus()){
                        ...
                        Intent intent = new Intent(getActivity(),WinFailActivity.class);
                        startActivity(intent);
                        getFragmentManager().popBackStack();
