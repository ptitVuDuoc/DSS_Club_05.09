...
import com.dss.dssClub.fragment.AccountFragment;
import com.dss.dssClub.fragment.BaseFragment;
import com.dss.dssClub.fragment.HistoryFragment;
import com.dss.dssClub.fragment.LoginFragment;
import com.dss.dssClub.fragment.ScanFragment;
import com.dss.dssClub.fragment.ScanQRcodeFragment;
import com.dss.dssClub.fragment.WinFragment;
...
public class MainAppActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void registerDeviceID(){
        ...
        String phone = PrefUtils.getString(getApplicationContext(), KeyConst.NUMBER_PHONE_STATISTIC);
        jsonObject.addProperty(KeyConst.NUMBER_PHONE,phone );
        jsonObject.addProperty(KeyConst.DEVICE_ID, idDevice);

        mAPIService.postRawJSONRegisterDeviceID(jsonObject).enqueue(new Callback<RegisterDeviceID>() {
            @Override
            ...
            @Override
            public void onFailure(Call<RegisterDeviceID> call, Throwable t) {
            }
        });
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_nofi:
                ...
                Intent intent = new Intent(MainAppActivity.this,ListNotificationActivity.class);
                startActivity(intent);
