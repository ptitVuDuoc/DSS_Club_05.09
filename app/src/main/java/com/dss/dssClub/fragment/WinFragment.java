...
public class WinFragment extends com.dss.dssClub.fragment.BaseFragment implements View.OnClickListener,
    ...
    public void onResume() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (mScannerView != null) {
                    mScannerView.setResultHandler(WinFragment.this);
                    mScannerView.startCamera(mCameraId);
                    mScannerView.setAutoFocus(mAutoFocus);
                    mScannerView.resumeCameraPreview(WinFragment.this);
                }
                hideLoadCamera();
            }
        }, 200);
            ...
            public void onResponse(Call<CheckInQRcode> call, Response<CheckInQRcode> response) {
                if (response != null) {
                    ...
                    if (response.body().getStatus()) {
                        ...
                        intent.putExtra(KeyConst.INTENT_PUT_SUB, response.body().getSubject());
